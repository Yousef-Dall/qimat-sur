export const STRINGS = {
  en: {
    ...
    specialised: {
      ...
      items: [
        { id: "volvo", alt: "Volvo" },
        { id: "scania", alt: "Scania" },
        { id: "fuso", alt: "FUSO Canter" },
        { id: "isuzu", alt: "Isuzu" },
        { id: "mercedes", alt: "Mercedes-Benz" },
        { id: "man", alt: "MAN" },
      ],
    },
    ...
    tca: {
      heading_capacity: "QSMT Technical Capacity",
      capacity: [
        {
          id: "team",
          alt: "QSMT engineering team",
          caption:
            "Qualified mechanical & electrical engineers & highly skilled Technicians",
        },
        {
          id: "offroad",
          alt: "Off-road emergency response team",
          caption: "Well trained Off-Road Emergency Response",
        },
        {
          id: "tools",
          alt: "Workshop tools and equipment",
          caption: "Latest high-standard tools and equipment",
        },
      ],
      heading_approach: "QSMT Approach",
      approach: [
        {
          id: "service",
          title: "Service Excellence:",
          text: "Quality of service is the cornerstone of repair & maintenance in QSMT—covering the technical work and the overall customer experience.",
        },
        {
          id: "market",
          title: "Market Analysis:",
          text: "Understanding local demand, identifying the target customer base, and recognizing the competition are crucial.",
        },
        {
          id: "adapt",
          title: "Adaptation & Growth:",
          text: "The automotive industry evolves fast; QSMT invests in training and modern diagnostics to stay ahead of the curve.",
        },
      ],
    },
      ...
      members: [
        {
          ...
          bio: "Over 35 years of experience in transport & road safety management, including maintenance and fleet management in leading companies in Oman and the region.",
          email: "m.aldawoodi@qsmtoman.com",
          phone: "009689139474",
        },
        {
          id: "yaser",
          name: "Eng. Yasser Abdul Aziz Gad",
          role: "Shareholder & Managing Director",
          bio: "Mechanical engineer with more than 25 years in mechanics workshops and vehicle maintenance in Egypt, Oman, and the region.",
        ...
        },
        {
          ...
          bio: "Mechanical engineer specialized in maintenance and repair of heavy trucks and large equipment, with 8+ years’ experience.",
  ...
  ar: {
    ...
    about: {
      ...
      services: [
        {
          id: "repair",
          title: "الإصلاحات الميكانيكية والكهربائية",
          desc: "إصلاح جميع أعطال الأنظمة الميكانيكية والكهربائية وأنظمة التحكم في الدوائر.",
        },
        {
          id: "inspection",
          title: "تحسين وتجديد المركبات.",
          desc: "تنفيذ تجديد شامل للسيارات والمقطورات، بما في ذلك إضافة جميع أنواع الإكسسوارات، وأعمال الإصلاح والتركيب.",
        },
        {
          id: "cooling",
          title: "وحدات التبريد.",
          desc: "فحص وصيانة وإصلاح جميع أنواع وحدات التبريد المتنقلة.",
        },
        {
          id: "painting",
          title: "أعمال الطلاء.",
          desc: "دهان جميع المركبات وفقًا لأعلى معايير جودة الطلاء والتشطيب.",
        },
        {
          id: "fleet",
          title: "إدارة المركبات",
          desc: "اتفاقية مصممة خصيصًا لإدارة مختلف فئات مركباتك، لضمان سير العمليات بسلاسة ودون فقدان وقت.",
        },
        {
          id: "preventive",
          title: "فحوصات وتقارير وصيانة دورية",
          desc: "فحوصات دورية وتقارير لمساعدتك في منع الأعطال وتقليل وقت التوقف، والحفاظ على مركباتك بأفضل شكل.",
        },
        {
          id: "emergency",
          title: "الدعم الطارئ في المناطق الوعرة",
          desc: "توفير خدمة دعم فوري في حال حدوث أعطال طارئة في أي مكان.",
        },
        {
          id: "manufacture",
          title: "تصنيع المقطورات.",
          desc: "تصنيع وتجديد جميع أنواع المقطورات شبه الصغيرة والصغيرة لجميع الأغراض، وفقًا لجميع المعايير الوطنية والدولية.",
        },
        {
          id: "contracts",
          title: "العقود واتفاقيات مستوى الخدمة",
          desc: "يمكن توفير جميع خدمات قمة صور عبر نطاق عقد مخصص للعميل و/أو اتفاقيات مستوى خدمة وباقات مصممة خصيصًا.",
        },
      ],
    },
    ...
    team: {
      ...
      members: [
        {
          id: "mubarak",
          name: "مبارك حمد الداودي",
          role: "شريك ومدير عام",
          bio: "أكثر من 35 عامًا من الخبرة في إدارة النقل وسلامة الطرق، بما في ذلك الصيانة وإدارة المركبات في كبرى الشركات في سلطنة عمان والمنطقة.",
          email: "m.aldawoodi@qsmtoman.com",
          phone: "009689139474",
        },
        {
          id: "yaser",
          name: "م. ياسر عبد العزيز جاد",
          role: "شريك ومدير عام",
          bio: "مهندس ميكانيكي لديه أكثر من 25 عامًا من الخبرة في ورش الميكانيكا وصيانة المركبات في مصر وسلطنة عمان والمنطقة.",
          email: "yassr.abdulaziz@qsmtoman.com",
          phone: "0096892405017",
        },
        {
          id: "sakher",
          name: "صخر مبارك الداودي",
          role: "شريك ومدير التسويق والعلاقات العامة",
          bio: "خريج عُماني في إدارة الأعمال، يمتلك معرفة قوية بالقوانين والإجراءات العُمانية، وشبكة واسعة من العلاقات في السوق.",
          phone: "0096879677735",
        },
        {
          id: "dhiaa_sup",
          name: "طه ممدوح محمد",
          role: "مشرف صيانة",
          bio: "مهندس ميكانيكي متخصص في صيانة وإصلاح الشاحنات الثقيلة والمعدات الكبيرة، بخبرة تزيد عن 8 سنوات.",
          email: "operations@qsmtoman.com",
          phone: "0096835869729",
        },
        {
