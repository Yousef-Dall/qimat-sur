...
// icons (paths shortened in your snippet; keep your real ones)
...
export default function StickyHeader() {
  ...
  const IDLE_MS = 4000;
  const HOTZONE_H = 160; // <- as requested: must hover within top 160px
  ...
  // wa.me requires international format w/o "+" or "00"
  // 00968 93689729  ->  96893689729
...
/>
      ...
      >
        ...
        <nav className="qsmtHeader__nav" aria-label="Primary">
          <button type="button" className="pill" onClick={() => go("services")}>
            {t("header.nav.services")}
          </button>
          <button type="button" className="pill" onClick={() => go("location")}>
            {t("header.nav.location")}
          </button>
          <button type="button" className="pill" onClick={() => go("gallery")}>
            {t("header.nav.gallery")}
          </button>
          <button type="button" className="pill" onClick={() => go("staff")}>
            {t("header.nav.staff")}
          </button>
        </nav>
      </header>
