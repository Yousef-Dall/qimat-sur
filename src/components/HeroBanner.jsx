...
const HeroSection = styled(Box)(({ theme, dir }) => ({
  position: 'relative',
...
const HeroBadge = styled(Box)(({ isAr }) => ({
  position: 'absolute',
...
const TrucksImage = styled(Box)(({ isAr }) => ({
  position: 'absolute',
  right: isAr ? 'auto' : '0',
  left: isAr ? '0' : 'auto',
  bottom: '20vh',
...
const HeroTitle = styled(Typography)(({ isAr }) => ({
  position: 'absolute',
...
const Tagline = styled(Typography)(({ isAr }) => ({
  position: 'absolute',
  ...
  return (
    ...
    >
      ...
      <HeroInner>
        ...
        <HeroBadge isAr={isAr}>
          <BadgeCircle>
            <BadgeLogo src={qsmtLogo} alt="QSMT logo" />
          </BadgeCircle>
        </HeroBadge>

        {/* Decorative trucks image */}
        <TrucksImage isAr={isAr} aria-hidden="true">
          <img src={trucksPng} alt="" />
        </TrucksImage>

        {/* Brand + sub */}
        <HeroTitle component="h1" isAr={isAr}>
